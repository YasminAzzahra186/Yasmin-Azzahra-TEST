...
* **Credit Card UI**: Tampilan visual kartu kredit yang elegan dengan gradien warna yang menarik.
* **Search Functionality**: Bar pencarian yang adaptif sesuai dengan ukuran layar.
* **Sticky Header**: Header yang tetap berada di atas saat halaman di-scroll untuk memudahkan navigasi.
* **HTML5**: Struktur semantik untuk konten web.
* **Tailwind CSS**: Framework CSS utility-first untuk styling.
* **JavaScript (Vanilla)**: Digunakan untuk logika interaksi seperti *toggle sidebar*.
